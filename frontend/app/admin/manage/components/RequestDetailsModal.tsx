              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 bg-indigo-50 border border-indigo-200 rounded-2xl">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="font-bold text-indigo-900">Documents joints</span>
                  </div>
                  <p className="text-4xl font-black text-indigo-600">{request.documents}</p>
                  <p className="text-indigo-700 mt-2">Fichiers disponibles au téléchargement</p>
                </div>
              </div>
            )}
          </div>
