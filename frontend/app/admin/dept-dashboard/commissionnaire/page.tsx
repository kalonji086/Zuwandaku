...
import {
  LayoutDashboard, FileText, Users, TrendingUp, Settings,
  BarChart3, History, Download, ExternalLink, ToggleLeft, ToggleRight,
...
const INIT: Module[] = [
  { id: 'c-dashboard',    label: 'Dashboard',          description: "Vue d'ensemble, KPIs, commissions et activité récente.",    href: '/commissionnaire',                    icon: LayoutDashboard, color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-transactions', label: 'Transactions',        description: 'Suivi de toutes les transactions et commissions (5%).',    href: '/commissionnaire/transactions',       icon: FileText,        color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-biens',        label: 'Biens & Véhicules',   description: 'Catalogue des biens et véhicules gérés.',                  href: '/commissionnaire/biens',              icon: BarChart3,       color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-clients',      label: 'Clients',             description: 'Gestion des clients et propriétaires partenaires.',        href: '/commissionnaire/clients',            icon: Users,           color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-performance',  label: 'Performance',         description: 'Statistiques de performance et taux de conversion.',       href: '/commissionnaire/performance',        icon: TrendingUp,      color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-historique',   label: 'Historique paiements',description: 'Historique complet des paiements et commissions reçues.',  href: '/commissionnaire/historique-paiements', icon: History,       color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-export',       label: 'Export',              description: 'Export des données en CSV/PDF pour reporting.',            href: '/commissionnaire/export',             icon: Download,        color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'c-settings',     label: 'Paramètres',          description: 'Paramètres du compte commissionnaire.',                   href: '/commissionnaire/settings',           icon: Settings,        color: '#ff6b35', groupe: 'Espace Commissionnaire', actif: true  },
  { id: 'a-espaces',      label: 'Espace Admin',        description: 'Vue admin de l\'espace commissionnaire (contrôle).',       href: '/admin/espaces/commissionnaire',      icon: Briefcase,       color: '#00c2ff', groupe: 'Admin Commissionnaire',  actif: true  },
];

const GROUPE_COLOR: Record<string, string> = { 'Espace Commissionnaire': '#ff6b35', 'Admin Commissionnaire': '#00c2ff' };
...
export default function CommissionnaireModule() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      {toast && <div style={{ position: 'fixed', top: 20, right: 20, zIndex: 200, background: '#ff6b35', color: '#fff', padding: '10px 18px', borderRadius: 10, fontSize: 13, fontWeight: 600 }}>{toast}</div>}

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 }}>
        {[{ label: 'Total modules', value: modules.length, color: '#ff6b35', icon: Briefcase }, { label: 'Actifs', value: actifs, color: '#00e5a0', icon: CheckCircle }, { label: 'Désactivés', value: modules.length - actifs, color: '#f87171', icon: XCircle }].map(s => (
      ...
      {['Espace Commissionnaire', 'Admin Commissionnaire'].map(groupe => {
